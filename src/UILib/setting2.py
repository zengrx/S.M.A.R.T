...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label.setGeometry(QtCore.QRect(10, 4, 141, 16))
        self.label.setObjectName(_fromUtf8("label"))
        self.listWidget_2 = QtGui.QListWidget(self.page)
        self.listWidget_2.setGeometry(QtCore.QRect(10, 24, 301, 192))
        ...
        self.checkBox.setGeometry(QtCore.QRect(10, 70, 141, 24))
