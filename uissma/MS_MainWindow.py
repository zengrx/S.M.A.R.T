...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.checkBox_11.setMaximumSize(QtCore.QSize(60, 15))
        ...
        self.checkBox_2.setMaximumSize(QtCore.QSize(90, 15))
        ...
        self.lineEdit_2.setMaximumSize(QtCore.QSize(50, 15))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_11.setText(_translate("MainWindow", "全选", None))
        self.checkBox_7.setText(_translate("MainWindow", "YARA", None))
        self.checkBox_8.setText(_translate("MainWindow", "Clamav", None))
        self.checkBox_9.setText(_translate("MainWindow", "PEiD", None))
        self.checkBox_10.setText(_translate("MainWindow", "自定义规则", None))
        self.checkBox_2.setText(_translate("MainWindow", "启用白名单", None))
        self.label_3.setText(_translate("MainWindow", "文件类型：", None))
        self.checkBox_3.setText(_translate("MainWindow", "全选", None))
        self.checkBox.setText(_translate("MainWindow", "PE", None))
        self.checkBox_6.setText(_translate("MainWindow", "Office", None))
        self.checkBox_4.setText(_translate("MainWindow", "脚本", None))
        self.checkBox_13.setText(_translate("MainWindow", "压缩包", None))
        self.checkBox_12.setText(_translate("MainWindow", "多媒体", None))
        self.checkBox_5.setText(_translate("MainWindow", "自定义后缀：", None))
        self.groupBox.setTitle(_translate("MainWindow", "扫描策略", None))
        ...
        self.PB_ScanType.setText(_translate("MainWindow", "开  始", None))
